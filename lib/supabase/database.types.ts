...
export type Database = {
  public: {
    Tables: {
      ...
      >;
      articles: Table<
        { id: string; title: string; category: string; summary: string; content: string; content_blocks: Json; reference_items: Json; cover_image_url: string | null; reading_time: number | null; status: ArticleStatus; published_at: string | null; created_at: string; updated_at: string },
        { id?: string; title?: string; category?: string; summary?: string; content?: string; content_blocks?: Json; reference_items?: Json; cover_image_url?: string | null; reading_time?: number | null; status?: ArticleStatus; published_at?: string | null; created_at?: string; updated_at?: string },
        { title?: string; category?: string; summary?: string; content?: string; content_blocks?: Json; reference_items?: Json; cover_image_url?: string | null; reading_time?: number | null; status?: ArticleStatus; published_at?: string | null; updated_at?: string }
      >;
